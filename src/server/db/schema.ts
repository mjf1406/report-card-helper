...
export const subject_achievement_comments = sqliteTable('subject_achievement_comments',
    {
        ...
        year: text('year'),
        reading: text('reading'), // remember to JSON.parse() this when reading
        writing: text('writing'), // remember to JSON.parse() this when reading
        speaking: text('speaking'), // remember to JSON.parse() this when reading
        listening: text('listening'), // remember to JSON.parse() this when reading
        use_of_english: text('use_of_english'), // remember to JSON.parse() this when reading
        mathematics: text('mathematics'), // remember to JSON.parse() this when reading
        social_studies: text('social_studies'), // remember to JSON.parse() this when reading
        science: text('science'), // remember to JSON.parse() this when reading
    }
)
